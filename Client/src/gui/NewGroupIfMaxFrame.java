...
public class NewGroupIfMaxFrame extends EmptyAboutGroupFrame{
    JLabel error;
    enum ErrorTypes {
        None, FILL_GRAPH;
    ...
    JButton add;
    public NewGroupIfMaxFrame(Database db){
